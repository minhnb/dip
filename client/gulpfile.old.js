...
gulp.task('uglify', ['uglify:react-l20n', 'uglify:app']);
...
if(production) {
    ...
    gulp.task('default', function(callback) {
        runSequence('react:development:server', 'react:app', 'build:css', 'build:essentials', 'base64-css', ['watch'], callback);
    });
}

gulp.task('development', function(callback) {
    runSequence('react:app', 'notify', callback);
});
