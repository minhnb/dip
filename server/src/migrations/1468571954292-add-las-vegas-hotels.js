...
let imagePath = "assets/1468571954292-add-las-vegas-hotels";

exports.up = function(next) {
	let listHotels = require(__dirname + '/assets/LasVegasHotels.json');
...
function saveListHotels(hotelImages, poolImages, hotels, next) {
    ...
    console.info('begin inserting Las Vegas hotel');
