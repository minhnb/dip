...
let lasVegasId = "miami";
let imagePath = "assets/1468897016244-add-miami-hotels";

exports.up = function(next) {
	let listHotels = require(__dirname + '/assets/MiamiHotels.json');
...
function saveListHotels(hotelImages, poolImages, hotels, next) {
    ...
    console.info('begin inserting Miami hotel');
