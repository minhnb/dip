...
/**
     * Modified from https://github.com/jaredhanson/oauth2orize/blob/master/examples/all-grants/oauth2.js
...
exports.authorization = [login.ensureLoggedIn(), server.authorization(function (clientID, redirectURI, done) {
