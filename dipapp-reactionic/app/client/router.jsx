...
import App from './imports/components/dip/app';
import Layout from './imports/components/layouts/dipMain.jsx';
...
import IntroductionSlide from './imports/components/dip/introductionSlide.jsx';

var main = function () {
    var pageList = [
        {path: '/', component: IntroductionSlide, title: 'DIP - Introduction', done: true},
    ...
    let mainRoute = (
        <Route component={Layout}>
            <IndexRoute component={IntroductionSlide}/>
            {pageRoutes}
        </Route>
    );
